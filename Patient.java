...
public class Patient extends User {
    ...
    private String Path="./Data/AppointmentRecord.csv";
    	...
    	while(true) {
           ...
           /* try (BufferedReader br = new BufferedReader(new FileReader(Path))) {
    		...
    		for (int i2 = 0; i2 < app.size(); i2++) {
        		...
        		if(app.get(i2).getTime().equals(apptime)&&app.get(i2).getDoctor().equals(bookdoc)&&app.get(i2).getStatus().equals("Confirmed")) {
    		...
    		String[] data = {Name,bookdoc ,formatter.format(selectedDate).toString(), apptime,"Confirmed","NIL"};
